Edco Core version 3.0.5 is now available from:
...
Edco Core version 3.0.5 is a recommended update for all users. This release
...
installer (on Windows) or just copy over `/Applications/Edco-Qt` (on Mac)
or `edcod`/`edco-qt` (on Linux).

Compatibility
=============

Edco Core is extensively tested on multiple operating systems using
the Linux kernel, macOS 10.8+, and Windows Vista and later. Windows XP is not supported.

Edco Core should also work on most other Unix-like systems but is not
...
- `0789160` Fix: check doc script failed due to misspelled backupxEDCO instead of backupxion (cevap)
...
- `44e16ef` Replace all occurencies of EDCO-Qt with Edco-Qt (cevap)
- `e36f97a` Add splashscreens, fixed #10 (cevap)
- `1a08917` Rename all occurencies from ' EDCO ' to ' Edco ' (cevap)
...
- `6439a59` Rename bitcoin.org to educore.xyz, ref: #13 (cevap)
...
- `e17311c` Edcoian Documentation (#23) (ckti)
- `9d05d8e` Edco Build Documaentation for Raspian (#24) (ckti)
