...
In order to support loading of multiple wallets in edco-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is edco.cpp.
...
Changes to edco.cpp
----------------------
edco.cpp is the entry point into edco-qt, and as such, will require some minor modifications to provide hooks for
