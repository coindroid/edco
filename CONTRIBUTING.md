Contributing to Edco Core
============================

The Edco Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Edco Core project, and is not to be
confused with overall Edco Network Protocol consensus changes.

Whether a pull request is merged into Edco Core rests with the project merge
...
Patches that change Edco consensus rules are considerably more involved than
...
Where a patch set proposes to change the Edco consensus, it must have been
...
The project leader is the release manager for each Edco Core release.
