...
#   c) node1 mines 32 blocks, so now node 0 has 60001edco, node 1 has 4250edco, node2 has none.
#   d) node0 sends 601 edco to node2, in two transactions (301 edco, then 300 edco).
