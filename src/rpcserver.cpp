...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Edco features */
        {"edco", "masternode", &masternode, true, true, false},
        {"edco", "listmasternodes", &listmasternodes, true, true, false},
        {"edco", "getmasternodecount", &getmasternodecount, true, true, false},
        {"edco", "masternodeconnect", &masternodeconnect, true, true, false},
        {"edco", "masternodecurrent", &masternodecurrent, true, true, false},
        {"edco", "masternodedebug", &masternodedebug, true, true, false},
        {"edco", "startmasternode", &startmasternode, true, true, false},
        {"edco", "createmasternodekey", &createmasternodekey, true, true, false},
        {"edco", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"edco", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"edco", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"edco", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"edco", "getmasternodescores", &getmasternodescores, true, true, false},
        {"edco", "mnbudget", &mnbudget, true, true, false},
        {"edco", "preparebudget", &preparebudget, true, true, false},
        {"edco", "submitbudget", &submitbudget, true, true, false},
        {"edco", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"edco", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"edco", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"edco", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"edco", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"edco", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"edco", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"edco", "checkbudgets", &checkbudgets, true, true, false},
        {"edco", "mnsync", &mnsync, true, true, false},
        {"edco", "spork", &spork, true, true, false},
        {"edco", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"edco", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> edco-cli " + methodname + " " + args + "\n";
}
