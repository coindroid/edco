...
/* edco GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "EDCO"
#define QAPP_ORG_DOMAIN "edco-coin.com"
#define QAPP_APP_NAME_DEFAULT "Edco-Qt"
#define QAPP_APP_NAME_TESTNET "Edco-Qt-testnet"
