 ...
 */
    ...
    typeWidget->addItem(tr("Received Edco from xEDCO"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in xEDCO"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_xEDCO));
