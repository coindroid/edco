                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Edco Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Edco address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and edco: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for xEDCO"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Edco Core"), this);
    aboutAction->setStatusTip(tr("Show information about Edco Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for EDCO"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Edco addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Edco addresses"));
    ...
    openAction->setStatusTip(tr("Open a EDCO: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Edco Core help message to get a list with possible Edco command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Edco Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Edco network", "", count));
}
...
{
    QString strTitle = tr("Edco Core"); // default title
