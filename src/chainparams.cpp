...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of
        (       0,	uint256("00001652c475fc4b8a865f9955e0e213c57815642590b08a8fd26cc398ac7945") ); 
...
public:
    CMainParams()
    {
        ...
        nLastPOWBlock = 115;                         // PoW Phase 3 End
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "EDCO: An EDu-Coin-Online Edision.";
        genesis.nTime = 1551106826;                                        // GMT: Thursday, February 2, 2017 2:30:00 PM
...
*/
        assert(hashGenesisBlock == uint256("0x00001652c475fc4b8a865f9955e0e213c57815642590b08a8fd26cc398ac7945"));
        assert(genesis.hashMerkleRoot == uint256("0x641525b6d2b7d99a1d3a84cec175f2ba41cfd4aaf53d24595d403651417d5717"));

        // Edco addresses start with 'i'
	...
	vSeeds.push_back(CDNSSeedData("node1", "s1.edu-coin.online"));
        vSeeds.push_back(CDNSSeedData("node2", "s2.edu-coin.online"));
        vSeeds.push_back(CDNSSeedData("node3", "s3.edu-coin.online"));
        ...
        strObfuscationPoolDummyAddress = "EducoinDarksendPoo1DummyAdy4viSr";
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("1", "testnet.seeder.baseserv.com")); // Edco's official testseed 1
        vSeeds.push_back(CDNSSeedData("2", "testnet.seeder.uksafedns.net")); // Edco's official testseed 2
        // Testnet Edco addresses start with 'g'
...
public:
    CRegTestParams()
    {
        ...
        genesis.nNonce = 0x496f6e;                // hex 57 47 52 in text = EDCO
