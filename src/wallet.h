...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT20000IFMN = 3,
    ONLY_NONDENOMINATED_NOT20000IFMN = 4, // ONLY_NONDENOMINATED and not 20000 Edco at the same time
    ONLY_20000 = 5,                        // find masternode outputs including locked ones (use with caution)
    STAKABLE_COINS = 6                          // UTXO's that are valid for staking
};

// Possible states for xEDCO send
...
public:
    ...
    */
    ...
    /** xEDCO reset */
    boost::signals2::signal<void()> NotifyxEDCOReset;
};
