...
###   This script attempts to download the signature file SHA256SUMS.asc from educore.xyz
...
SIGNATUREFILE="https://educore.xyz/bin/3.0.4.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://educore.xyz/bin/"
