...
RESOURCES += src/qt/edco.qrc src/qt/edco_locale.qrc

TRANSLATIONS += src/qt/locale/edco_bg.ts \
                src/qt/locale/edco_de.ts \
                src/qt/locale/edco_en.ts \
                src/qt/locale/edco_es.ts \
                src/qt/locale/edco_fi.ts \
                src/qt/locale/edco_fr.ts \
                src/qt/locale/edco_it.ts \
                src/qt/locale/edco_ja.ts \
                src/qt/locale/edco_pl.ts \
                src/qt/locale/edco_pt.ts \
                src/qt/locale/edco_ru.ts \
                src/qt/locale/edco_sk.ts \
                src/qt/locale/edco_sv.ts \
                src/qt/locale/edco_vi.ts \
                src/qt/locale/edco_zh_CN.ts \
                src/qt/locale/edco_zh_TW.ts
