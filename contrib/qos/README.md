...
This means one can have an always-on edcod instance running, and another local edcod/edco-qt instance which connects to this node and receives blocks from it.
